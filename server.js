...
const db = pgp(
  process.env.DATABASE_URL ||
    "postgres://akppnbjeltipma:d83a3e7a826cd09a205551a1e4063b60f365201ca4ad6ed875dfdc5cb4e07bac@ec2-54-243-46-32.compute-1.amazonaws.com:5432/d35h8248bl7gm9?ssl=true"
);
...
app.get("/api/schools", (req, res) => {
  ...
  db.query(
    "SELECT name, w2019, l2019 from teams WHERE w2019 is not null order by name asc;"
  )
    .then((data) => {
      res.send(data);
    })
